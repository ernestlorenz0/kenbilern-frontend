  ...
  return (
    <section className="relative w-[1920px] h-[1080px] bg-yellow-100 flex overflow-hidden">
      ...
      <div className="w-1/2 p-16 flex flex-col justify-center">
        <h2 className="text-7xl font-bold text-yellow-900 mb-6">{title}</h2>
        <div className="w-28 h-2 bg-yellow-500 mb-8 rounded-full"></div>
        <p className="text-[3rem] text-yellow-900 leading-relaxed max-w-2xl">
          {content}
        </p>
      </div>
    </section>
...
export function MainSlide2({ title, content, title2, content2 }) {
  return (
    <section className="relative w-[1920px] h-[1080px] bg-gradient-to-br from-yellow-200 to-orange-100 flex flex-col items-center justify-center overflow-hidden">
      {/* Floating organic shapes */}
      <div className="absolute top-24 left-24 w-56 h-56 bg-yellow-300/40 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 right-32 w-72 h-72 bg-orange-300/30 rounded-full blur-3xl"></div>

      {/* Top Half: First Term */}
      <div className="absolute top-[100px] left-0 right-0 h-[420px] px-20 z-10">
        <div className="h-full bg-white/90 border-8 border-yellow-400 rounded-3xl shadow-2xl p-8 flex flex-col justify-center">
          <h2 className="text-6xl font-bold text-yellow-800 mb-4">{title || 'Term 1'}</h2>
          <div className="w-28 h-2 bg-yellow-500 mb-6 rounded-full"></div>
          <p className="text-[2.7rem] text-yellow-900 leading-relaxed">{content || 'Definition for term 1'}</p>
        </div>
      </div>

      {/* Bottom Half: Second Term */}
      <div className="absolute bottom-[100px] left-0 right-0 h-[420px] px-20 z-10">
        <div className="h-full bg-white/90 border-8 border-orange-400 rounded-3xl shadow-2xl p-8 flex flex-col justify-center">
          <h2 className="text-6xl font-bold text-orange-800 mb-4">{title2 || 'Term 2'}</h2>
          <div className="w-28 h-2 bg-orange-500 mb-6 rounded-full"></div>
          <p className="text-[2.7rem] text-orange-900 leading-relaxed">{content2 || 'Definition for term 2'}</p>
        </div>
      </div>
    </section>
  );
...
export function MainSlide3({ title, content }) {
  return (
    <section className="relative w-[1920px] h-[1080px] overflow-hidden flex items-center justify-center bg-gradient-to-tr from-yellow-100 via-amber-50 to-orange-100">
      {/* Soft abstract waves */}
      <div className="absolute bottom-0 left-0 w-full h-[500px] bg-[radial-gradient(circle_at_bottom_left,rgba(255,200,0,0.4),transparent_70%)]"></div>
      <div className="absolute top-0 right-0 w-full h-[400px] bg-[radial-gradient(circle_at_top_right,rgba(255,180,50,0.4),transparent_70%)]"></div>

      {/* Curvy layered shape (like a paper wave) */}
      <svg
      ...
      >
        <path
          fill="#fde68a"
          fillOpacity="0.8"
          d="M0,224L60,197.3C120,171,240,117,360,90.7C480,64,600,64,720,90.7C840,117,960,171,1080,186.7C1200,203,1320,181,1380,170.7L1440,160L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"
        ></path>
      </svg>
      ...
      {/* Content */}
      <div className="relative z-10 text-center px-24 max-w-5xl">
        <h2 className="text-7xl font-extrabold text-yellow-900 mb-8 drop-shadow-lg">
          {title}
        </h2>
        <p className="text-5xl text-yellow-800 leading-relaxed font-light">
          {content}
        </p>
      </div>

      {/* Decorative dotted arc */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] border-dotted border-[6px] border-yellow-300/40 rounded-full"></div>
    </section>
  );
}
...
export function MainSlide4({ title, content, title2, content2 }) {
  return (
    <section className="relative w-[1920px] h-[1080px] bg-orange-100 overflow-hidden flex items-center justify-center">
      {/* Diagonal title band */}
      ...
      <div className="absolute left-[100px] top-1/2 -translate-y-1/2 w-[800px] z-10">
        <div className="bg-white/90 border-8 border-yellow-400 rounded-3xl shadow-2xl p-10">
          <h2 className="text-6xl font-extrabold text-yellow-900 mb-6">{title || 'Term 1'}</h2>
          <div className="w-28 h-2 bg-yellow-500 mb-6 rounded-full"></div>
          <p className="text-[2.7rem] text-orange-900 leading-relaxed">{content || 'Definition for term 1'}</p>
        </div>
      </div>

      {/* Right: Second Term */}
      <div className="absolute right-[100px] top-1/2 -translate-y-1/2 w-[800px] z-10">
        <div className="bg-white/90 border-8 border-orange-400 rounded-3xl shadow-2xl p-10">
          <h2 className="text-6xl font-extrabold text-orange-900 mb-6">{title2 || 'Term 2'}</h2>
          <div className="w-28 h-2 bg-orange-500 mb-6 rounded-full"></div>
          <p className="text-[2.7rem] text-orange-900 leading-relaxed">{content2 || 'Definition for term 2'}</p>
        </div>
      </div>
  ...
  return (
    <section className="relative w-[1920px] h-[1080px] flex items-center justify-center bg-gradient-to-br from-yellow-200 via-orange-100 to-yellow-50 overflow-hidden">
      ...
      <div className="relative z-10 text-center px-16">
        ...
        <p className="text-[2.7rem] text-yellow-900 max-w-4xl mx-auto leading-relaxed">
          {content}
        </p>
      </div>
    </section>
  ...
  return (
    <section className="relative w-[1920px] h-[1080px] overflow-hidden bg-gradient-to-tr from-yellow-100 to-orange-50 flex flex-col justify-center">
      ...
      <div className="relative z-10 px-32">
        ...
        <p className="text-[2.7rem] text-yellow-900 leading-relaxed max-w-4xl">
          {content}
        </p>
      </div>
    </section>
