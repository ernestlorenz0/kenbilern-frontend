...
const SignUpPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Your account has been created successfully. Please check your inbox and spam folder for the verification email before signing in.');
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs" style={{ color: '#666666' }}>
                      We will send your account verification link to this email address. Please check your inbox and spam folder.
                    </p>
                  </div>
