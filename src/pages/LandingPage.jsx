...
import Sticker1 from '../STI LOGOS/sticker1.png';
import Sticker2 from '../STI LOGOS/sticker2.png';
import Sticker3 from '../STI LOGOS/sticker3.png';
import Sticker4 from '../STI LOGOS/sticker4.png';
import Sticker5 from '../STI LOGOS/sticker5.png';
import Sticker6 from '../STI LOGOS/sticker6.png';
import Sticker8 from '../STI LOGOS/sticker8.png';
import Sticker9 from '../STI LOGOS/sticker9.png';
import Sticker10 from '../STI LOGOS/sticker10.png';
import Sticker11 from '../STI LOGOS/sticker11.png';
      ...
      <nav className="fixed top-0 left-0 right-0 z-50" style={{ backgroundColor: 'rgba(255, 255, 255, 0.98)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(229, 229, 229, 0.3)' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-4">
              <Link to="/login" className="text-sm font-semibold px-6 py-3 rounded-xl border hover:shadow-lg transition-all duration-300" style={{ color: '#003D7A', borderColor: '#E5E5E5', backgroundColor: 'white' }}>Login</Link>
              <Link to="/signup" className="px-6 py-3 text-sm font-bold text-white rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300" style={{ backgroundColor: '#003D7A' }}>
                Get Started
              </Link>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`${isVisible ? 'animate-slideInLeft' : 'opacity-0'}`}>
              ...
              <p className="text-xl mb-10 leading-relaxed" style={{ color: '#2C2C2C' }}>
                Experience the future of presentation creation with KenbiLearn's AI technology. Convert any PDF into professional, engaging presentations in seconds.
              </p>
              <div className="flex flex-col sm:flex-row gap-6">
                <Link to="/signup" className="px-10 py-5 text-lg font-bold text-white rounded-2xl shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 floating-element" style={{ backgroundColor: '#003D7A', boxShadow: '0 20px 40px rgba(0, 61, 122, 0.3)' }}>
                ...
                <Link to="/demo" className="px-10 py-5 text-lg font-semibold rounded-2xl border-2 hover:shadow-lg transform hover:scale-105 transition-all duration-300 modern-card" style={{ color: '#003D7A', borderColor: '#003D7A', backgroundColor: 'rgba(255, 255, 255, 0.9)' }}>
                  <span className="flex items-center justify-center space-x-2">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={`${isVisible ? 'animate-slideInRight' : 'opacity-0'} relative`}>
              <div className="relative w-full h-96 flex items-center justify-center">
                ...
                <div className="absolute top-2 left-2 rotate-slow" style={{ animationDelay: '0.2s' }}>
                  <img 
                    src={Sticker1} 
                    alt="STI Innovation Badge" 
                    className="w-16 h-auto object-contain opacity-100" 
                  />
                </div>
                
                {/* Sticker 2 - Top Right Corner */}
                <div className="absolute top-2 right-2 pulse-scale" style={{ animationDelay: '0.4s' }}>
                  <img 
                    src={Sticker2} 
                    alt="STI Excellence Seal" 
                    className="w-14 h-auto object-contain opacity-100" 
                  />
                </div>
                
                {/* Sticker 3 - Left Side */}
                <div className="absolute top-24 left-0 swing" style={{ animationDelay: '0.6s' }}>
                  <img 
                    src={Sticker3} 
                ...
                <div className="absolute top-28 right-0 slide-horizontal" style={{ animationDelay: '0.8s' }}>
                  <img 
                    src={Sticker4} 
                ...
                <div className="absolute bottom-2 left-2 bounce-crazy" style={{ animationDelay: '1s' }}>
                  <img 
                    src={Sticker5} 
                ...
                <div className="absolute bottom-2 right-2 floating-element" style={{ animationDelay: '1.2s' }}>
                  <img 
                    src={Sticker6} 
                ...
                <div className="absolute top-1/2 left-4 bounce-crazy" style={{ animationDelay: '1.4s', transform: 'translateY(-50%)' }}>
                  <img 
                    src={Sticker8} 
                ...
                <div className="absolute top-1/2 right-4 pulse-scale" style={{ animationDelay: '1.6s', transform: 'translateY(-50%)' }}>
                  <img 
                    src={Sticker9} 
                ...
                <div className="absolute bottom-12 left-1/4 swing" style={{ animationDelay: '1.8s', transform: 'translateX(-50%)' }}>
                  <img 
                    src={Sticker10} 
                ...
                <div className="absolute top-8 right-1/4 rotate-slow" style={{ animationDelay: '2s', transform: 'translateX(50%)' }}>
                  <img 
                    src={Sticker11} 
          ...
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
            {[
              ...
              },
              {
                ...
                description: "Choose from 20 professionally designed themes.",
                color: "#003D7A",
                ...
                >
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <div className="mb-8 flex justify-center">
                      <div 
                        className="w-24 h-24 rounded-3xl flex items-center justify-center shadow-2xl transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-500"
                        style={{ backgroundColor: feature.color }}
                      >
                        <div className="transform group-hover:scale-110 transition-transform duration-300" style={{ color: feature.color === '#FFC72C' ? '#003D7A' : 'white' }}>
                          {feature.icon}
                        </div>
                      </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="text-center">
              ...
              <p style={{ color: '#2C2C2C' }}>Committed to delivering the high quality presentations</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p style={{ color: '#2C2C2C' }}>Here to help teachers and students achieve their goals</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-12 mt-16">
            <div className="text-center">
              ...
              <p className="text-lg" style={{ color: '#2C2C2C' }}>ernestjamesonlorenzon@gmail.com</p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center space-x-4 mb-6 md:mb-0">
              <img src={STILogo1} alt="STI College" className="h-12 w-auto" />
              <div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-600 text-center">
            <p className="text-gray-300 text-sm">
              © 2024 KenbiLearn - Ernest Jameson Lorenzo. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
